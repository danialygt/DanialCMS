            ...
            b.define("select2/selection/search", ["jquery", "../utils", "../keys"], function (a, b, c) {
                ...
                return (
                    (d.prototype.render = function (b) {
                        var c = a(
                            '<li class="select2-search select2-search--inline"><input class="select2-search__field w-100" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" role="textbox" aria-autocomplete="list" /></li>'
                        );
            ...
            b.define("select2/dropdown", ["jquery", "./utils"], function (a, b) {
                ...
                return (
                    ...
                    (c.prototype.render = function () {
                        ...
                        return b.attr("dir", "rtl"), (this.$dropdown = b), b;
                    }),
            ...
            b.define("select2/dropdown/search", ["jquery", "../utils"], function (a, b) {
                ...
                return (
                    (c.prototype.render = function (b) {
                        var c = b.call(this),
                            d = a(
                                '<span class="select2-search select2-search--dropdown"><input class="select2-search__field w-100" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" role="textbox" /></span>'
                            );
                ...
                return (
                    (e.prototype.fromElement = function (a) {
                        ...
                        null == this.options.multiple && (this.options.multiple = a.prop("multiple")),
                            ...
                            null == this.options.dir && (a.prop("dir") ? (this.options.dir = a.prop("dir")) : a.closest("[dir]").prop("dir") ? (this.options.dir = a.closest("[dir]").prop("dir")) : (this.options.dir = "rtl")),
            ...
            b.define("select2/core", ["jquery", "./options", "./utils", "./keys"], function (a, b, c, d) {
                ...
                return (
                    ...
                    (e.prototype.render = function () {
                        ...
                        return b.attr("dir", "rtl"), (this.$container = b), this.$container.addClass("select2-container--" + this.options.get("theme")), b.data("element", this.$element), b;
                    }),
                    e
                );
            }),
