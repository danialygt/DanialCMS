...
namespace DanialCMS.Infrastructure.DAL.SqlServer.Migrations
{
    ...
    [Migration("20201101121010_AddEditorEntities")]
    partial class AddEditorEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DanialCMS.Core.Domain.Contents.Entities.ContentEditors", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DanialCMS.Core.Domain.Editors.Entities.Editor", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DanialCMS.Core.Domain.Contents.Entities.ContentEditors", b =>
                {
                    ...
                    b.HasOne("DanialCMS.Core.Domain.Editors.Entities.Editor", "Editor")
                        .WithMany()
